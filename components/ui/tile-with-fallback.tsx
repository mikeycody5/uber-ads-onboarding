...
export function TileWithFallback({ imageSrc, imageAlt, className = "", onClick }: TileProps) {
  return (
    <div
      ...
      <div className="relative w-full h-full">
        {imageSrc ? (
          <ImageWithFallback
            ...
            fallbackSrc={`/placeholder.svg?height=200&width=200&query=${encodeURIComponent(imageAlt)}`}
          />
        ) : (
