...
// Icon components based on Base Web icons
export function GaugeIcon({ size = 24, color = "currentColor", className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <path
        d="M12 6C11.45 6 11 6.45 11 7V10C11 10.55 11.45 11 12 11C12.55 11 13 10.55 13 10V7C13 6.45 12.55 6 12 6Z"
        fill={color}
      />
    </svg>
  )
  ...
  return (
    ...
    >
      <path
        ...
        fill={color}
      />
      <path d="M12.5 7H11V13L16.2 16.2L17 14.9L12.5 12.2V7Z" fill={color} />
    </svg>
  )
}
...
export function MoneyIcon({ size = 24, color = "currentColor", className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
